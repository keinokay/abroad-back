...
public class QnaReplyApiController {
	...
	public ResponseDto<Page<Reply>> finByBoardIdReply(@PathVariable String site, @PathVariable int qnaId, @PageableDefault(size = 20, sort = "id", direction = Sort.Direction.ASC) Pageable pageable) {
